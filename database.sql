...
create table check_ins (  id int not null auto_increment primary key,  number varchar(255),  eventId varchar(255),  content long, timestamp TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP);
